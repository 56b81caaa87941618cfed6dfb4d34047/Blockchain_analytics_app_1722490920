Vue.component('sidebar_1722491243', { template: `<nav class="fixed top-0 left-0 w-fit h-full bg-gray-100 space-y-8 sm:w-80 pt-10 text-black z-20">
      ...
      <div>
        ...
        <div class="py-4 px-4 w-fit border-t border-black">
          <div class="flex items-centergap-x-4">
            <div>
              <span class="block text-white-700 text-sm font-semibold">Unlock Blockchain Insights</span>
              <a href="javascript:void(0)" class="block mt-px text-white-600 text-xs">Gain real-time visibility into new blockchain data</a>
            </div>
          </div>
        </div>
      </div>
